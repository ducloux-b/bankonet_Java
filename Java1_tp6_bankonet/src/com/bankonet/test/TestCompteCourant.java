...
public class TestCompteCourant {
	...
	public static void main(String[] args) {
		CompteCourant compteCourant1 = new CompteCourant(1, "compte1", 100, 20);
		CompteCourant compteCourant2 = new CompteCourant(2, "compte2", 3000, 0);
		CompteCourant compteCourant3 = new CompteCourant(3, "compte3", 100000,
				200);
		...
		CompteCourant[] compteCourantTab = { compteCourant1, compteCourant2,
				compteCourant3 };

		CompteCourant compteCourant4 = new CompteCourant(4, "compte4", -50, 20);
