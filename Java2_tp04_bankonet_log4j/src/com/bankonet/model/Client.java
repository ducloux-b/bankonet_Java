...
public class Client implements Comparable<Client>
	...
	Log logger = LogFactory.getLog(TestClient.class);

	public Client(int identifiant, String nom, String prenom,
						List<Compte> compteCourantList, List<Compte> compteEpargneList)
		{
		super();
		this.identifiant= (Integer)identifiant;
		this.nom= nom;
		this.prenom= prenom;
	...
	// this.comptes.remove(compte);
	// }
	// public Compte retournerCompte(String numero) throws
	...
	public int compareTo(Client client)
		...
		if(client instanceof Client)
			...
			return this.getIdentifiant()
					.compareTo(((Client)client).getIdentifiant());
			}
